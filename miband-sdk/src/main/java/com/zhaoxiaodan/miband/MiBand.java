...
public class MiBand {
    ...
    public void addDisconnectedListener(NotifyListener disconnectedListener) {
        this.io.addDisconnectedListener(disconnectedListener);
    }
    ...
    public void setOnButtonPress(NotifyListener notifyListener){
        this.io.setNotifyListener(Profile.UUID_SERVICE_MIBAND_SERVICE, Profile.UUID_BUTTON_TOUCH, notifyListener);
    }
